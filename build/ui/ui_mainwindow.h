...
**
** Created: Wed Dec 22 00:31:15 2021
...
public:
    ...
    QAction *actionReturn_main;
    QAction *actionChange_general;
    QAction *actionCheck_resource;
    QAction *actionCStandard;
    QAction *actionSgs_OL;
    QAction *actionCGolden_Snake;
    QAction *actionGStandard;
    QAction *actionGGolden_Snake;
    QAction *actionCustom;
    QAction *actionEnable_Lua;
    QAction *actionPause;
    QAction *actionAbout_libtomcrypt;
    QAction *actionFile_encryption_decryption;
    ...
    QMenu *menuHelp;
    QMenu *menuView;
    QMenu *menuCard_style;
    QMenu *menuGeneral_style;
    QMenu *menuCheat;
    QMenu *menuDIY;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionJoin_Game->setObjectName(QString::fromUtf8("actionJoin_Game"));
        ...
        actionScript_editor->setEnabled(false);
        actionScript_editor->setVisible(false);
        ...
        actionReturn_main = new QAction(MainWindow);
        actionReturn_main->setObjectName(QString::fromUtf8("actionReturn_main"));
        actionChange_general = new QAction(MainWindow);
        actionChange_general->setObjectName(QString::fromUtf8("actionChange_general"));
        actionCheck_resource = new QAction(MainWindow);
        actionCheck_resource->setObjectName(QString::fromUtf8("actionCheck_resource"));
        actionCStandard = new QAction(MainWindow);
        actionCStandard->setObjectName(QString::fromUtf8("actionCStandard"));
        actionCStandard->setCheckable(true);
        actionSgs_OL = new QAction(MainWindow);
        actionSgs_OL->setObjectName(QString::fromUtf8("actionSgs_OL"));
        actionSgs_OL->setCheckable(true);
        actionCGolden_Snake = new QAction(MainWindow);
        actionCGolden_Snake->setObjectName(QString::fromUtf8("actionCGolden_Snake"));
        actionCGolden_Snake->setCheckable(true);
        actionGStandard = new QAction(MainWindow);
        actionGStandard->setObjectName(QString::fromUtf8("actionGStandard"));
        actionGStandard->setCheckable(true);
        actionGGolden_Snake = new QAction(MainWindow);
        actionGGolden_Snake->setObjectName(QString::fromUtf8("actionGGolden_Snake"));
        actionGGolden_Snake->setCheckable(true);
        ...
        actionEnable_Lua = new QAction(MainWindow);
        actionEnable_Lua->setObjectName(QString::fromUtf8("actionEnable_Lua"));
        actionEnable_Lua->setCheckable(true);
        actionPause = new QAction(MainWindow);
        actionPause->setObjectName(QString::fromUtf8("actionPause"));
        actionPause->setCheckable(true);
        actionAbout_libtomcrypt = new QAction(MainWindow);
        actionAbout_libtomcrypt->setObjectName(QString::fromUtf8("actionAbout_libtomcrypt"));
        actionFile_encryption_decryption = new QAction(MainWindow);
        actionFile_encryption_decryption->setObjectName(QString::fromUtf8("actionFile_encryption_decryption"));
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QString::fromUtf8("centralWidget"));
        MainWindow->setCentralWidget(centralWidget);
        menuBar = new QMenuBar(MainWindow);
        menuBar->setObjectName(QString::fromUtf8("menuBar"));
        menuBar->setGeometry(QRect(0, 0, 2560, 29));
        ...
        menuCard_style = new QMenu(menuView);
        menuCard_style->setObjectName(QString::fromUtf8("menuCard_style"));
        menuGeneral_style = new QMenu(menuView);
        menuGeneral_style->setObjectName(QString::fromUtf8("menuGeneral_style"));
        ...
        menuGame->addAction(actionJoin_Game);
        menuGame->addSeparator();
        menuGame->addAction(actionRestart_game);
        menuGame->addAction(actionReturn_main);
        ...
        menuOptions->addAction(actionRole_assign_table);
        menuOptions->addSeparator();
        menuOptions->addAction(actionFile_encryption_decryption);
        menuOptions->addAction(actionBroadcast);
        menuOptions->addAction(actionAI_Melee);
        menuOptions->addAction(actionReplay_file_convert);
        menuOptions->addAction(actionCheck_resource);
        menuOptions->addSeparator();
        ...
        menuHelp->addAction(actionAbout_libtomcrypt);
        ...
        menuView->addAction(menuCard_style->menuAction());
        menuView->addAction(menuGeneral_style->menuAction());
        menuCard_style->addAction(actionCStandard);
        menuCard_style->addAction(actionCGolden_Snake);
        menuCard_style->addAction(actionSgs_OL);
        menuGeneral_style->addAction(actionGStandard);
        menuGeneral_style->addAction(actionGGolden_Snake);
        menuGeneral_style->addAction(actionCustom);
        menuCheat->addAction(actionGet_card);
        menuCheat->addAction(actionChange_general);
        ...
        menuDIY->addSeparator();
        menuDIY->addAction(actionEnable_Lua);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        actionStart_Game->setShortcut(QApplication::translate("MainWindow", "Ctrl+S", 0, QApplication::UnicodeUTF8));
        actionJoin_Game->setText(QApplication::translate("MainWindow", "Join game", 0, QApplication::UnicodeUTF8));
        actionJoin_Game->setShortcut(QApplication::translate("MainWindow", "Ctrl+G", 0, QApplication::UnicodeUTF8));
        ...
        actionRestart_game->setShortcut(QApplication::translate("MainWindow", "F4", 0, QApplication::UnicodeUTF8));
        actionReturn_main->setText(QApplication::translate("MainWindow", "Return main", 0, QApplication::UnicodeUTF8));
        actionReturn_main->setShortcut(QApplication::translate("MainWindow", "F3", 0, QApplication::UnicodeUTF8));
        actionChange_general->setText(QApplication::translate("MainWindow", "Change general ...", 0, QApplication::UnicodeUTF8));
        actionCheck_resource->setText(QApplication::translate("MainWindow", "Check resource", 0, QApplication::UnicodeUTF8));
        actionCStandard->setText(QApplication::translate("MainWindow", "Standard", 0, QApplication::UnicodeUTF8));
        actionSgs_OL->setText(QApplication::translate("MainWindow", "Sgs OL", 0, QApplication::UnicodeUTF8));
        actionCGolden_Snake->setText(QApplication::translate("MainWindow", "Golden Snake", 0, QApplication::UnicodeUTF8));
        actionGStandard->setText(QApplication::translate("MainWindow", "Standard", 0, QApplication::UnicodeUTF8));
        actionGGolden_Snake->setText(QApplication::translate("MainWindow", "Golden Snake", 0, QApplication::UnicodeUTF8));
        actionCustom->setText(QApplication::translate("MainWindow", "Custom", 0, QApplication::UnicodeUTF8));
        actionEnable_Lua->setText(QApplication::translate("MainWindow", "Enable Lua", 0, QApplication::UnicodeUTF8));
        actionPause->setText(QApplication::translate("MainWindow", "&Pause", 0, QApplication::UnicodeUTF8));
        actionPause->setShortcut(QApplication::translate("MainWindow", "Pause", 0, QApplication::UnicodeUTF8));
        actionAbout_libtomcrypt->setText(QApplication::translate("MainWindow", "About libtomcrypt", 0, QApplication::UnicodeUTF8));
        actionFile_encryption_decryption->setText(QApplication::translate("MainWindow", "File encryption/decryption ...", 0, QApplication::UnicodeUTF8));
        ...
        menuCard_style->setTitle(QApplication::translate("MainWindow", "Card style", 0, QApplication::UnicodeUTF8));
        menuGeneral_style->setTitle(QApplication::translate("MainWindow", "General style", 0, QApplication::UnicodeUTF8));
