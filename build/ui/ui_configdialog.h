...
**
** Created: Wed Dec 4 14:33:53 2013
...
public:
    ...
    QCheckBox *closelightBox;
    QCheckBox *disableLua;
    QWidget *tab;
    ...
    void setupUi(QDialog *ConfigDialog)
    {
        ...
        layoutWidget5->setGeometry(QRect(10, 20, 331, 116));
        ...
        neverNullifyMyTrickCheckBox = new QCheckBox(layoutWidget5);
        ...
        formLayout->setWidget(2, QFormLayout::LabelRole, neverNullifyMyTrickCheckBox);

        minimizecCheckBox = new QCheckBox(layoutWidget5);
        minimizecCheckBox->setObjectName(QString::fromUtf8("minimizecCheckBox"));
        minimizecCheckBox->setChecked(true);

        formLayout->setWidget(3, QFormLayout::LabelRole, minimizecCheckBox);

        closelightBox = new QCheckBox(layoutWidget5);
        closelightBox->setObjectName(QString::fromUtf8("closelightBox"));
        closelightBox->setChecked(false);

        formLayout->setWidget(4, QFormLayout::LabelRole, closelightBox);

        disableLua = new QCheckBox(layoutWidget5);
        disableLua->setObjectName(QString::fromUtf8("disableLua"));
        disableLua->setChecked(true);

        formLayout->setWidget(5, QFormLayout::LabelRole, disableLua);
    ...
    void retranslateUi(QDialog *ConfigDialog)
    {
        ...
        closelightBox->setToolTip(QApplication::translate("ConfigDialog", "if emotions mutual interference", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        closelightBox->setText(QApplication::translate("ConfigDialog", "Close Light Box", 0, QApplication::UnicodeUTF8));
        disableLua->setText(QApplication::translate("ConfigDialog", "Disable Lua Generals", 0, QApplication::UnicodeUTF8));
