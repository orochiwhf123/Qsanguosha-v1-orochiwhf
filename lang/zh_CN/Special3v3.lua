...
-- 1、关羽：增加忠义技能
	["x~zhongyi"] = "忠义",
	[":x~zhongyi"] = "<b>限定技</b>，（3V3）出牌阶段，你可以将一张红色手牌置于武将牌上。你的武将牌上有牌时，己方角色使用的【杀】伤害+1。身份牌重置时，弃置你武将牌上的牌。",
...
-- 2、赵云：增加救主技能
	["x~jiuzhu"] = "救主",
	[":x~jiuzhu"] = "（3V3）当己方一名其他角色处于濒死状态时，你可以失去1点体力并弃置一张牌，然后该角色回复1点体力。\
◆你的体力值为1时不能发动“救主”。",

-- 3、吕布 ：增加战神技能
	["x~zhanshen"] = "战神",
	[":x~zhanshen"] = "<b>觉醒技</b>，（3V3）回合开始阶段开始时，若你已受伤且己方有角色已阵亡，你须减1点体力上限并弃置装备区里的武器牌，然后获得技能“马术”和“神戟”（当你的装备区里没有武器牌时，你使用的【杀】可以额外指定至多两个目标）。",
	["xzhanshen"] = "战神",

-- 4、夏侯敦：修改刚烈技能
	[":3v3:ganglie"] = "每当你受到一次伤害后，你可以指定一名角色并进行一次判定，若结果不为红桃，则对方选择弃置两张手牌，或受到你对其造成的1点伤害。",
