...
return {
    ...
    ["$chongzhen1"] = "赤胆平乱世，龙枪定江山！",
	["$chongzhen2"] = "我等化身为龙，贯穿敌阵！",
	...
	["$lihun1"] = "将军~这些都赏给妾身好不好嘛~", -- 发动技能
	["$lihun2"] = "这些人家不喜欢嘛~还给你吧~", -- 翻回牌
	["$lihun3"] = "将军，此舞如何？", -- 单对吕布发动
	["$lihun4"] = "太师，别看呆了哦~", -- 单对董卓发动
	...
	["cv:bgm_caoren"] = "喵小林",
	["$kuiwei1"] = "休整片刻，待我杀出一条血路！",
	["$kuiwei2"] = "起兵列队，准备突围！",
	["$yanzheng1"] = "行伍严整，百战不殆！",
	["$yanzheng2"] = "任你横行霸道，我自岿然不动！",
    ...
    "摸牌阶段你可以少摸一张牌，指定你攻击范围内的一名其他角色亮出牌堆顶上3张牌，将其中全部的非基本牌和【桃】置于弃牌堆，该角色进行二选一：你对其造成X点伤害或他依次弃置X张牌，然后你获得这些基本牌。（X为其中非基本牌的数量）。",
	["zhaolie:damage"] = "受伤害",
	["zhaolie:throw"] = "弃牌",
	["shichou"] = "誓仇",
	...
	["hate"] = "誓仇",
	["@bird"] = "撮鸟",
	["@shichou"] = "你可以指定一名蜀国角色发动【誓仇】",
	["#ShichouProtect"] = "%from 的技能【%arg】被触发，%to 代其承受本次伤害。",
	["$zhaolie1"] = "不灭东吴，誓不归蜀！", -- 造成伤害摸牌
	["$zhaolie2"] = "汝等勿劝，此战势在必行！", -- 你获得牌
	...
	["cv:bgm_daqiao"] = "蒲小猫",
	["yanxiao"] = "言笑",
	[":yanxiao"] = "出牌阶段你可以将一张方块牌置于一名角色的判定区内，判定区内有“言笑”牌的角色下一个判定阶段开始时，获得其判定区内的所有牌。",
	["#Yanxiao"] = "%from 受到【%arg】技能影响，回收了判定区内的所有牌",
	["smile"] = "言笑牌",
	[":smile"] = "言笑牌，☆SP大乔专属牌，平时置于判定区，但不属于延时锦囊，不受延时锦囊的限制。可被拆顺转移，在同一角色的判定区里也可以有多张言笑牌。",
	["anxian"] = "安娴",
