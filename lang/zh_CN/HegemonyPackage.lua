...
-- general
	...
	["yuejin"] = "乐进",
	["xiaoguo"] = "骁果",
	[":xiaoguo"] = "其他角色的回合结束阶段，你可以弃置一张基本牌，若如此做，该角色需弃置一张非基本牌，否则受到你对其造成的1点伤害。",
	...
	["shenzhi"] = "神智",
	[":shenzhi"] = "回合开始阶段，你可以弃置所有手牌，若你以此法弃置的牌的张数不小于X，你回复1点体力（X为你当前的体力值）。",
	...
	["zoushi"] = "邹氏",
	["huoshui"] = "祸水",
	[":huoshui"] = "回合结束阶段，你可以将武将牌翻面并指定一名其他角色翻面。",
	["qingcheng"] = "倾城",
