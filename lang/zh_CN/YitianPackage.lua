...
return {
	...
	["yitian_sword"] = "倚天剑",
	[":yitian_sword"] = "1. 你的回合外，你每受到一次伤害，在其结算完后你可以立即使用一张【杀】2. 当此剑从装备区失去时，你可用此剑指定一名角色受到你造成的1点无属性伤害",
	["yitian_sword:yes"] = "你可以指定一名角色受到你造成的一点无属性伤害",
	["yitian-lost"] = "倚天剑",
	...
	["weiwudi"] = "魏武帝",
	["guishin"] = "歸心",
	[":guishin"] = "回合结束阶段，你可以做以下二选一：\
      1. 永久改变一名其他角色的势力\
      2. 永久获得一项未上场或已死亡角色的主公技。(获得后即使你不是主公仍然有效)",
	["guishin:yes"] = "永久改变一名其他角色的势力或永久获得一项未上场或已死亡角色的主公技。",
	["guishin:modify"] = "永久改变一名其他角色的势力",
	["guishin:obtain"] = "永久获得一项未上场或已死亡角色的主公技",
	...
	["ca0chong"] = "曹冲",
	["chengx1ang"] = "称象",
	[":chengx1ang"] = "每当你受到1次伤害，你可打出X张牌（X小于等于3），它们的点数之和与造成伤害的牌的点数相等，你可令X名角色各恢复1点体力（选完牌后再选定角色；若其满体力则摸2张牌）。",
	["@chengxiang-card"] = "请打出点数之和为 %arg 的卡牌以发动【称象】技能",
	["conghui"] = "聪慧",
	[":conghui"] = "<b>锁定技</b>，你将永远跳过你的弃牌阶段。",
	["zaoyao"] = "早夭",
	[":zaoyao"] = "<b>锁定技</b>，回合结束阶段，若你的手牌大于13张，则你必须弃置所有手牌并流失1点体力。",
	...
	该效果直到你的下回合开始阶段为止，你选择的五灵效果不可与上回合重复\
	[风]场上所有角色受到的火焰伤害+1\
	[雷]场上所有角色受到的雷电伤害+1\
	...
	["luboyanf"] = "陆伯言(女)",
	["shenjun"] = "神君",
	[":shenjun"] = "<b>锁定技</b>，异性角色对你造成的非雷电属性伤害无效。",
	["shaoying"] = "烧营",
	[":shaoying"] = "当你对一名不处于连环状态的角色造成一次火焰伤害后，你可选择一名其距离为1的另外一名角色并进行一次判定：若判定结果为红色，则你对选择的角色造成一点火焰伤害。",
	["zonghuo"] = "纵火",
	...
	["gongmou"] = "共谋",
	["@conspiracy"] = "共谋",
	[":gongmou"] = "回合结束阶段，可指定一名其他角色：其在摸牌阶段摸牌后，须给你X张手牌（X为你手牌数与对方手牌数的较小值），然后你须选择X张手牌交给对方（若X≤2，只还1张）。",
	...
	["jiawenhe"] = "贾文和",
	["dongcha"] = "洞察",
	[":dongcha"] = "回合开始阶段，你可以指定一名其他角色：该角色的所有手牌对你处于可见状态，直到你的本回合结束。其他角色都不知道你对谁发动了洞察技能，包括被洞察的角色本身。\
★注：本技能无法在面杀中操作。",
	["dushi"] = "毒士",
	[":dushi"] = "<b>锁定技</b>，杀死你的角色获得崩坏技能直到游戏结束。\
★董卓杀死贾文和后，不会因为两个崩坏而触发两次。",
	["@collapse"] = "崩坏",
	...
	["guzhielai"] = "古之恶来",
	["sizhan"] = "死战",
	[":sizhan"] = "<b>锁定技</b>，你防止受到的伤害并获得与伤害点数等量的死战标记；回合结束阶段开始时弃掉所有X点死战标记，并根据出牌阶段是否造成伤害流失X点/1点体力。",
	["shenli"] = "神力",
	[":shenli"] = "<b>锁定技</b>，出牌阶段，你造成的<font color='red'>第一次伤害</font>+X，X为当前死战标记数。",
	["#SizhanPrevent"] = "%from 的锁定技【%arg2】被触发，防止了当前的 %arg 点伤害",
	["#SizhanLoseHP"] = "%from 的锁定技【%arg2】被触发，流失了 %arg 点体力",
	["#ShenliBuff"] = "%from 的锁定技【神力】被触发，伤害增加了 %arg, 达到了 %arg2 点",
	["@struggle"] = "死战",
	...
	["dengshizai"] = "邓士载",
	["zhenggong"] = "争功",
	[":zhenggong"] = "其他角色的回合即将开始时，若你的武将牌正面向上，你可以将你的武将牌翻面并立即进入你的回合，你的回合结束后，进入该角色的回合。",
	["toudu"] = "偷渡",
	[":toudu"] = "当你的武将牌背面向上时若受到伤害，你可以弃置一张手牌并将你的武将牌翻面，视为对一名其他角色使用了一张【杀】。",
	["@zhenggong"] = "争功",
	["@toudu"] = "偷渡：你可以弃置一张手牌并将你的武将牌翻面，视为对一名其他角色使用了一张【杀】",
...
-- CV&Designer
	...
	["cv:ca0chong"] = "神马芯",
	["$chengx1ang1"] = "置象舟上，刻其水痕所至。", --发动技能
	["$chengx1ang2"] = "称物载之，则校可知矣。", --恢复体力
	["$conghui"] = "吾虽年幼，智意所及，有若成人。",
	["$zaoyao"] = "咳咳咳……",
	["~ca0chong"] = "仓舒，仓舒啊……", -- 曹冲老妈的声音
