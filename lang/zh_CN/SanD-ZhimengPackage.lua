...
return {
	...
	["gangli"] = "刚戾",
	[":gangli"] = "你受到其他角色造成的伤害后，可以：选择除伤害来源外的另一名角色，视为伤害来源对该角色使用一张【杀】（此【杀】无距离限制且不计入出牌阶段使用次数限制）。",
	["cv:diychengyu"] = "清水浊流",
	["$pengri"] = "汝刚而无礼义，匹夫之雄耳。",
	["$gangli"] = "拔亡为存，转祸为福。",
	...
	["jingrui"] = "精锐",
	[":jingrui"] = "若你的手牌数≥你的体力值，你可以将一张手牌当做【杀】或【闪】使用或打出。",
	["cv:diychendao"] = "黄昏",
	...
	["zha0xin"] = "昭心",
	[":zha0xin"] = "出牌阶段，若你的手牌数≥你的体力值，你可以展示全部手牌。若均为不同花色，你令一名角色失去1点体力。若均为同一花色，你获得一名其他角色一张牌。每阶段限一次。",
	["huaiyi"] = "怀异",
	...
	["youqi"] = "忧戚",
	[":youqi"] = "<b>觉醒技</b>，回合开始阶段结束时，若你的体力为1，你须减1点体力上限，并永久获得技能“缔盟”和“空城”。 ",
	...
	["quanjian"] = "劝谏",
	[":quanjian"] = "出牌阶段限一次，你可以交给一名其他角色一张【闪】，然后双方各摸1张牌。",
	["sijie"] = "死节",
