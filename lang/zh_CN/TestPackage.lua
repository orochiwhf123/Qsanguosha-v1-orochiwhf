...
-- danchuang
	...
	["v5baijiang"] = "拜將",
	[":v5baijiang"] = "<b>觉醒技</b>，回合结束阶段，若你装备区的牌≥3，你失去技能【权计】和【争功】并获得技能“野心”（你每造成或受到一次伤害，可将牌堆顶的一张牌放置在武将牌上，称为“权”。出牌阶段限一次，你可以用任意数量的手牌与等量的“权”交换）。",
	["#BaijiangWake"] = "%from 身上的装备达到 %arg 张，觉醒技【%arg2】触发",
	["v5yexin"] = "野心",
	[":v5yexin"] = "你每造成或受到一次伤害，可将牌堆顶的一张牌放置在武将牌上，称为“权”。出牌阶段限一次，你可以用任意数量的手牌与等量的“权”交换。",
	["werpo"] = "權",
	["v5zili"] = "自立",
	[":v5zili"] = "<b>觉醒技</b>，回合开始阶段，若你的“权”为四张或更多时，你减1点体力上限，并永久获得技能“排异”（回合结束阶段，将一张“权”移动到任何合理的区域，若不是你的区域，你可以摸一张牌）。",
	...
	["cv:v5zhonghui"] = "极光星逝",
	["$v5zhenggong"] = "夺得军权方能施展一番。",
	["$v5quanji1"] = "终于轮到我掌权了。", -- 发动拼点
	["$v5quanji2"] = "此地容不下你。", -- 赢
	["$v5quanji3"] = "先让你得意几天。", -- 没赢
	["$v5baijiang"] = "时机已到，今日起兵！",
	["$V5baijiang"] = "请兵拜将，领军伐逆；\
破蜀之日，功成之时！",
	["$v5yexin1"] = "这仇，我记下了···", -- 受到伤害
	["$v5yexin2"] = "非我族者，其心可诛！", -- 交换牌
	["$v5zili"] = "以我之才，何必屈人之下！",
	["$V5zili"] = "大权在握，功高振军；\
自立蜀中，以图天下！",
	["$v5paiyi1"] = "妨碍我的人，都得死！", -- 放进自己的区域
	["$v5paiyi2"] = "待我设计构陷之···", -- 放进其他人的区域并摸牌
	["~v5zhonghui"] = "大权在手竟一夕败亡，时耶？命耶？",
...
-- test
	...
	["nosjuejing"] = "绝境",
	[":nosjuejing"] = "<b>锁定技</b>，摸牌阶段，你不摸牌。你的手牌数变化后，若不为4，你须将手牌调整至4张。",
	["noslonghun"] = "龙魂",
	[":noslonghun"] = "你可将一张牌按以下规则使用或打出：<font color=\"red\">♥</font>当【桃】；<font color=\"red\">♦</font>当火【杀】；♠当【无懈可击】；♣当【闪】。回合开始阶段，若其他角色的装备区内有【青釭剑】，你可以获得之。",
	["#noslonghun_duojian"] = "龙魂",
	[":#noslonghun_duojian"] = "回合开始阶段，若其他角色的装备区内有【青釭剑】，你可以获得之。",
