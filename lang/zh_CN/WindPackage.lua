...
1、跳过该回合的判定阶段和摸牌阶段\
2、跳过该回合出牌阶段并弃置一张装备牌\
你每做出上述一项选择，视为对至多两名其他角色使用了一张【杀】",
	["@shensu1"] = "跳过该回合的判定阶段和摸牌阶段，视为对至多两名其他角色使用了一张【杀】",
	["@shensu2"] = "跳过该回合出牌阶段并弃置一张装备牌视为对至多两名其他角色使用了一张【杀】",

	["#caoren"] = "大将军",
	["caoren"] = "曹仁",
	["jushou"] = "据守",
	[":jushou"] = "回合结束阶段，你可以摸４张牌，然后将你的武将牌翻面。",
	["jushou:yes"] = "摸４张牌，并将你的武将翻面",

	["#huangzhong"] = "老当益壮",
	["huangzhong"] = "黄忠",
	["liegong"] = "烈弓",
	[":liegong"] = "当你使用【杀】指定一名角色为目标后，以下两种情况，你可令此【杀】不可被【闪】响应：1、目标角色的手牌数≥你的体力值。2、目标角色的手牌数≤你的攻击范围\
★攻击范围计算只和武器有关，与+1马-1马无关",
	...
	["kuanggu"] = "狂骨",
	[":kuanggu"] = "<b>锁定技</b>，你对攻击范围内的一名角色造成１点伤害后，回复１点体力",

	["#zhangjiao"] = "天公将军",
	["zhangjiao"] = "张角",
	["illustrator:zhangjiao"] = "LiuHeng",
	["cv:zhangjiao"] = "官方，极光星逝",
	["leiji"] = "雷击",
	[":leiji"] = "你使用或打出一张【闪】时，可令一名角色判定，若结果为黑桃，你对该角色造成２点雷电伤害",
	["@leiji"] = "令任意一名角色判定，若为【黑桃】，你对该角色造成２点雷电伤害",
	["guidao"] = "鬼道",
	...
	["tianxiang"] = "天香",
	[":tianxiang"] = "你受到伤害时，可弃置一张红桃手牌来转移此伤害给任意一名角色，然后该角色摸Ｘ张牌（Ｘ=该角色当前已损体力值）",
	...
	["zhoutai"] = "周泰",
	["buqu"] = "不屈",
	[":buqu"] = "你扣减1点体力时，若你当前体力为0：你可以从牌堆顶亮出一张牌置于你的武将牌上，若该牌的点数与你武将牌上已有的任何一张牌都不同，你不会死亡；若出现相同点数的牌，你进入濒死状态\n◆你每移除一张不屈牌，摸２张牌\n◆每有一张不屈牌，手牌上限＋１",
	["buqu:alive"] = "我还想活",
	["buqu:dead"] = "我不想活了",
...
-- last words
	...
	["`zhangjiao"] = "天道昭昭，顺之者昌。黄天乐土已成，万民尽享其福！", 
