...
local t = {
	...
	["yicai"] = "异才",
	[":yicai"] = "每当你使用一张即时锦囊时(在它结算之前)，可立即对攻击范围内的一名其他角色使用一张计入使用限制的【杀】",
	["beifa"] = "北伐",
	[":beifa"] = "<b>锁定技</b>，当你失去最后一张手牌时，视为对一名其他角色使用了一张【杀】\
★北伐发动时，姜维必须一次做出决定：选择一名其他角色，视为对其使用一张【杀】",
	...
	["chouliang"] = "筹粮",
	[":chouliang"] = "回合结束阶段，若你手牌少于三张，你可以从牌堆顶亮出X张牌（X为4减当前手牌数），拿走其中的基本牌，把其余的牌置入弃牌堆",
...
--	["analeptic:ignore"] = "我是打酱油的~",
	...
	["badao"] = "霸刀",
	[":badao"] = "当你成为黑色的【杀】目标时，你可以对你攻击范围内的一名其他角色使用一张计入使用限制的【杀】",
	["wenjiu"] = "温酒",
