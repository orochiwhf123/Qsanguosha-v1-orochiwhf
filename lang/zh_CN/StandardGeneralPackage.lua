...
--wei
	...
	["caocao"] = "曹操",
	["jianxiong"] = "奸雄",
	[":jianxiong"] = "每当你受到一次伤害后，你可以获得对你造成伤害的牌，然后你可以选择：对一名角色使用之；不使用并摸１张牌\
★获得的“乱击”、“奇策”等虚拟卡牌不可使用，但你能摸１张牌\
★获得牌后若不能合法使用之，你摸１张牌",
	["use"] = "使用“奸雄”获得的牌",
	["notuse1"] = "伤害来源流失１点体力并翻面",
	["notuse2"] = "不使用并摸１张牌",
	["jianxionguse"] = "“奸雄①”效果【选择一名角色成为此牌的目标】",
	["huixuetip"] = "“奸雄②”效果【选择一名角色使其回复１点体力】",
	["maxhplost"] = "“奸雄③”效果【选择一名角色使其减少１点体力上限】",
	["hujia"] = "护驾",
	[":hujia"] = "<b>主公技</b>，当你需要使用（或打出）一张【闪】时，你可以令其他魏势力角色按行动顺序依次选择是否打出一张【闪】并摸１张牌（视为由你使用或打出），直到有一名角色或没有任何角色决定如此做时为止",
...
★若此时其他任何人都没有手牌，你就不能发动突袭",
	...
	["xiahoudun"] = "夏侯惇",
	["ganglie"] = "刚烈",
	[":ganglie"] = "每当你受到1点伤害后，你可以令伤害来源选择一项：弃置两张手牌，或受到你对其造成的1点伤害",
	["ganglie:yes"] = "令伤害来源受到你对其的1点无属性伤害或弃置2张手牌",

	["#simayi"] = "狼顾之鬼",
	["simayi"] = "司马懿",
	["fankui"] = "反馈",
	[":fankui"] = "每当你受到1点伤害后，你可以获得伤害来源的一张牌\
★若选择手牌则从对方手里随机抽取，选择面前的装备则由你任选",
	["guicai"] = "鬼才",
	[":guicai"] = "在一名角色的判定牌生效前，你可以打出一张牌代替之\
★包括手牌和装备",
	...
	["zhenji"] = "甄姬",
	["luoshen"] = "洛神",
	[":luoshen"] = "回合开始阶段，你可以进行一次判定，若结果为黑色，你获得此牌，你可以重复此流程，直到出现红色的判定结果为止",
	["qingguo"] = "倾国",
...
★使用仁德技能分出的牌，对方无法拒绝",
	["jijiang"] = "激将",
	[":jijiang"] = "<b>主公技</b>，当你需要使用（或打出）一张【杀】时，你可以发动激将。所有蜀势力角色按行动顺序依次选择是否打出一张【杀】然后摸１张牌（视为由你使用或打出），直到有一名角色或没有任何角色决定如此做时为止",
...
★使用龙胆时，仅改变牌的类别(名称)和作用，而牌的花色和点数不变",
	...
	["machao"] = "马超",
	["tieji"] = "铁骑",
	[":tieji"] = "当你使用【杀】指定一名角色为目标后，可进行一次判定，若结果不为黑桃，此【杀】不可被闪避",
	["mashu"] = "马术",
	[":mashu"] = "<b>锁定技</b>，当你计算与其他角色的距离时，始终-1\
★马术的效果与装备-1马时效果一样，但你仍然可以装备一匹-1马",
	["tieji:yes"] = "可判定一次，若判定结果不为黑桃，则此【杀】不可闪避",
...
--wu
	...
	["lianying"] = "连营",
	[":lianying"] = "当你失去手牌时，若手牌数≤１，你可以摸２张牌",
...
★使用奇袭时，仅改变牌的类别(名称)和作用，而牌的花色和点数不变",
	...
	["huanggai"] = "黄盖",
	["kurou"] = "苦肉",
	[":kurou"] = "出牌阶段，你可以失去1点体力，然后摸2张牌并使本回合手牌上限+3。每阶段中，你可以多次使用苦肉\
